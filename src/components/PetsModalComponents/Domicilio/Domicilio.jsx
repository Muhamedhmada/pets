...
export default function Domicilio({
  ...
  const hadnleSelectDep = (e) => {
    ...
    setNewPet({...newPit, departmento_id: e.value});
  };

  const handleSelectProv = (e) => {
    handleGetProvDis(e?.value);
    setNewPet({...newPit, provincia_id: e.value});
  };

  const handleSelectDis = (e) => {
    handleGetProvDis(e?.value);
    setNewPet({...newPit, districto_id: e.value});
  };
    ...
    <div>
      ...
      <div className='dom_input_group'>
        <CustomInput
          ...
          onChange={(e) => setNewPet({...newPit, direccion: e.target.value})}
          value={newPit.direccion}
        />
        <CustomInput
